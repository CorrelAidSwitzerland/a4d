...
tracker_data_file <- "/Volumes/Datacross_A4D/A4D/05_2021 AN Clinic IX A4D Tracker.xlsx" # TO DO: This line can be deleted and is just needed for testing of the function.
