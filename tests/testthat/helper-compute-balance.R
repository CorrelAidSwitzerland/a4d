...
df_balance_product <- data.frame(
    product = rep("Accu-Chek Performa Test Strips (100s/box)", 10),
    product_entry_date = c(
        "2020-12-31", "2020-01-01", "2020-01-11", "2020-01-12", "2020-01-18",
